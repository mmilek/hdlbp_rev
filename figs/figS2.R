# This script requires a transcriptome fasta file (line 60). 
# Due to size limitations, we could not provide it in the 
# github repository. In this work, we used a transcriptome fasta 
# file generated by RSEM during index build from gencode v19 gtf 
# annotation file.
...
#write.table(relevantBed[,c(1, 12, 2, 10, 13,14)], "data/considered.transcripts.bed", quote=F, sep="\t", row.names = F, col.names = F)
